  ...
  <header class="headerclass">
    <div class="header-body">
      <div class="header-logo">
        <a href="">
          <img src="img/guidelogo2.png" alt="鉄獄観光ガイド">
        </a>
      </div>
...
<div class="modal-002__wrap">
    ...
    <div class="modal-002">
        <div class="modal-002__content-wrap">
            ...
            <div class="scrollbox">
            <form id="advanced_search" class="modal-wrapper" method="GET" action="score_form.php">
              <!-- jsで生成 -->
            </form>
            </div>
        </div>
...
<div class="search-result">
    <div class="small-heading-section">
        <h2>
            検索結果
      <hr>
        </h2>
    ...
    if(count($dump_id) > 0){
      echo '<p>検索結果<br>';
        echo '- - - - - - - - - - - - - - - - - - - - - - - - </p>';
        for ($i=0;$i<count($dump_id);$i++){
          echo '<div>ダンプ番号：'.$dump_id[$i].'</div>';
          echo '<div>名前：'.$dump_name[$i].'</div>';
          echo '<div>スコア：'.$dump_score[$i].'</div>';
          echo '<p>- - - - - - - - - - - - - - - - - - - - - - - - </p>';
        }
      }else{
        if($o == true){
